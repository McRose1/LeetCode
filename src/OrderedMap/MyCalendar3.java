...
/*  732. My Calendar 3
    ...
    You class will be called like this: MyCalendarThree cal = new MyCalendarThree(); MyCalendarThree.book(start, end)
    ...
    Note:
        o The number of calls to MyCalendarThree.book per test case will be at most 400.
        o In calls to MyCalendarThree.book(start, end), start and end are integers in the range [0, 10^9].
