...
/*  706. Design HashMap
    ...
    To be specific, your design should include these functions:
        o put(key, value): Insert a (key, value) pair into the HashMap. If the value already exists in the HashMap, update the value.
        o get(key): Returns the value to which the specified key is mapped, or -1 if this map contains no mapping for the key.
        o remove(key): Remove the mapping for the value key if this map contains mapping for the key.
...
public class DesignHashMap {
    ...
    /** value will always non-negative. */
